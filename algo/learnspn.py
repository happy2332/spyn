...
class LearnSPN(object):
    ...
    def __init__(self,
        ...
        self.config["cluster_method"] = row_cluster_method
        self.config["cluster_n_clusters"] = n_cluster_splits
        self.config["cluster_prep_method"] = cluster_prep_method
        #self.config["cluster_iters"] = n_iters
